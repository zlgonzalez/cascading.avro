...
public class test1 extends org.apache.avro.specific.SpecificRecordBase
    ...
    @Deprecated
    public cascading.avro.md5 aFixed;
    @Deprecated
    public java.lang.Void aNull;
    @Deprecated
     ...
     */
    public test1(java.lang.Boolean aBoolean, java.lang.Integer anInt, java.lang.Long aLong, java.lang.Double aDouble,
            java.lang.Float aFloat, java.nio.ByteBuffer aBytes, cascading.avro.md5 aFixed, java.lang.Void aNull,
            java.lang.CharSequence aString, java.util.List<java.lang.Integer> aList,
    ...
    public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<test1>
        ...
        public test1 build() {
            try {
                ...
                record.aList = fieldSetFlags()[9] ? this.aList
                        : (java.util.List<java.lang.Integer>) defaultValue(fields()[9]);
                record.aMap = fieldSetFlags()[10] ? this.aMap
                        : (java.util.Map<java.lang.CharSequence, java.lang.Integer>) defaultValue(fields()[10]);
