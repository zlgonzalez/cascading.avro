...
public class AvroToCascadingTest {
	...
	public void setUp() throws Exception {
		Schema schema = new Schema.Parser().parse(getClass().getResourceAsStream(
                "test5.avsc"));
	...
	public void testFromMapNested() {
		...
		Map<String, Map<String,Long>> outMap = (Map<String, Map<String, Long>>) AvroToCascading.fromAvro(outerMap, outerSchema);
